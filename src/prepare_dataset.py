...
def main():
    ...
    parser.add_argument(
        "--version",
        required=True,
        help="Dataset version, for example v1, v2, v3, v4"
    )
    ...
    for example in examples:
        key = (example["input"], example["target"])
    ...
    # V4 formatting can legitimately change word count,
    # so we do NOT use the V3 word-count validation here.
